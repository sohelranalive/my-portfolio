...
import easyMovesClasses from "../assets/EasyMoves/classes.jpg";
import easyMovesFooter from "../assets/EasyMoves/Footer.jpg";
import easyMovesHome from "../assets/EasyMoves/Home.jpg";
import easyMovesInstructor from "../assets/EasyMoves/instructor.jpg";
import easyMovesLogin from "../assets/EasyMoves/login.jpg";
import easyMovesPopularClasses from "../assets/EasyMoves/PopularClass.jpg";
import easyMovesPopularInstructors from "../assets/EasyMoves/PopularInstructor.jpg";
    ...
    <div className="custom-shadow rounded-2xl p-8 md:flex space-y-4 md:space-y-0">
        ...
        <div className="carousel w-full">
          ...
          <div id="emslide1" className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
              <a
                href="#emslide7"
                className="btn btn-circle bg-blue-400 border-none opacity-70 hover:opacity-100 hover:bg-blue-400 mr-5"
              >
                ❮
              </a>
              <a
                href="#emslide2"
                className="btn btn-circle bg-blue-400 border-none opacity-70 hover:opacity-100 hover:bg-blue-400"
              >
                ❯
              </a>
            </div>
          ...
          <div id="emslide3" className="carousel-item relative w-full">
            <img
              src={easyMovesPopularInstructors}
      ...
      <div className="md:w-5/12 h-full md:ps-10">
        ...
        <p className="text-justify">
          An interactive Full stack MERN Application for dance class. This
          website basically targeted the students. In this application a normal
          user will be able to see different kind of classes and instructors
          details with some amazing functionality.
        </p>
        <br />
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 justify-around">
          <button className="px-2 py-3 rounded-lg shadow-xl bg-slate-100 font-bold text-xl">
            ReactJS
          </button>
          <button className="px-2 py-3 rounded-lg shadow-xl bg-slate-100 font-bold text-xl">
            Express
        ...
        <div className="flex space-x-6 justify-center w-full">
          <a
            href="https://github.com/sohelranalive/baby-soldier-client"
            target="_blank"
            rel="noopener noreferrer"
            className="flex space-x-2 text-2xl items-center hover:text-blue-400"
          >
            <span>Code</span>
            <FaGithub className="h-6 w-6" />
          </a>
          <a
            href="https://easy-moves-bb7bc.web.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex space-x-2 text-2xl items-center hover:text-blue-400"
          >
